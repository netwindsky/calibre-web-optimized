...
class _Settings(_Base):
    ...
    config_books_per_page = Column(Integer, default=30)
...
class ConfigSQL(object):
    ...
    def get_book_path(self):
        if getattr(self, 'config_calibre_split', False) and getattr(self, 'config_calibre_split_dir', None):
            return self.config_calibre_split_dir
